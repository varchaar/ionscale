...
func file_ionscale_v1_machines_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ionscale_v1_machines_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ionscale_v1_machines_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
